    ...
    <div className="bg-dark-900 min-h-screen flex flex-col md:flex-row">
      <div className="w-64 h-screen bg-dark-800 border-r border-dark-600 fixed left-0 top-0 h-[calc(100vh-76px)] overflow-y-auto">
        <div className="flex items-center justify-between border-b border-dark-600 p-4">
          ...
          <div className="flex items-center gap-1 bg-dark-700 px-2 py-1 rounded text-primary-400">
      ...
      <div className="flex-1 p-8 overflow-auto">
        <div className="w-full">{renderComponentError()}</div>
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
          ...
          <Card
            className="w-full col-span-3 bg-dark-800 border-dark-600 mt-4"
            withBorder
          >
        ...
        {selectedComponent && (
          <Card
            className="w-full bg-dark-800 border-dark-600 mt-4"
            withBorder
            padding="md"
          >
            <Text
