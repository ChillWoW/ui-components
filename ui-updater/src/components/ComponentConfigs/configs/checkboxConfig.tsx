      ...
      <div className="space-y-4 w-full">
        ...
        <div className="flex flex-col gap-1">
          ...
          <SelectInput
            ...
            onChange={(value) => setProps({ ...props, animation: value })}
            classNames={selectInputClasses}
          >
            <SelectInput.Option value="smooth" label="smooth" />
            <SelectInput.Option value="bounce" label="bounce" />
            <SelectInput.Option value="pulse" label="pulse" />
        ...
        <div className="flex flex-col gap-1">
          ...
          <RadioGroup
            ...
            onChange={(value) => setProps({ ...props, labelPosition: value })}
          >
