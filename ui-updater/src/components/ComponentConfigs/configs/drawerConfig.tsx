            ...
            <div className="space-y-4 w-full">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <Switch
                        ...
                        onChange={(value) =>
                            setProps({ ...props, disableScroll: value })
                        }
        ...
        <InfoPanel
            propInfo={{
                ...
                onClose: {
                    type: "function",
                    description:
                        "Determines the function when the drawer is closed"
                },
                position: {
                    type: "string",
                ...
                disableScroll: {
                    ...
                    default: true,
                    description:
                        "Determines if the drawer should disable scroll"
                },
                closeOnOverlayClick: {
                    type: "boolean",
                    default: true,
                    description:
                        "Determines if the drawer should close on overlay click"
                },
                animationDuration: {
                    type: "number",
                    default: 0.3,
                    description:
                        "Determines the animation duration of the drawer"
                },
                overlayAnimationDuration: {
                    type: "number",
                    default: 0.1,
                ...
                classNames: {
                    ...
                    properties: {
                        container: {
                            type: "string",
                            description:
                                "Determines the class name of the drawer container"
                        },
                        overlay: {
                            type: "string",
                            description:
                                "Determines the class name of the drawer overlay"
                        },
                        content: {
                            type: "string",
                            description:
                                "Determines the class name of the drawer content"
                        },
                        header: {
                            type: "string",
                            description:
                                "Determines the class name of the drawer header"
                        }
                    }
                }
            }}
