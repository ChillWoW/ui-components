        ...
        <InfoPanel
            propInfo={{
                ...
                color: {
                    type: "string",
                    description:
                        "Determines the color of the badge (only for filled)"
                },
                asLink: {
                    type: "boolean",
                ...
                target: {
                    type: "string",
                    description:
                        "Determines the target of the badge (link only)"
                },
                onClick: {
                    type: "function",
                    description:
                        "Determines the function when clicking the badge"
                },
                className: {
                    type: "string",
