            ...
            <div className="space-y-4 w-full">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <ButtonGroup
                        value={props.trigger}
                        onChange={(value) =>
                            setProps({ ...props, trigger: value })
                        }
                    >
                        <Button
                            onClick={() =>
                                setProps({ ...props, trigger: "click" })
                            }
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <Switch
                        ...
                        onChange={(checked) =>
                            setProps({ ...props, showItems: checked })
                        }
        ...
        <InfoPanel
            propInfo={{
                ...
                offset: {
                    ...
                    default: 5,
                    description:
                        "Distance in pixels between trigger and dropdown"
                },
                withArrow: {
                    type: "boolean",
                    default: false,
                ...
                closeOnItemClick: {
                    ...
                    default: true,
                    description:
                        "Determines if the menu closes when an item is clicked"
                },
                disabled: {
                    type: "boolean",
                    default: false,
                ...
                classNames: {
                    type: "object",
                    description:
                        "Additional CSS classes to apply to menu subcomponents",
                    properties: {
                        container: {
                            type: "string",
                        ...
                        trigger: {
                            type: "string",
                            description:
                                "CSS class for the menu trigger wrapper"
                        },
                        content: {
                            type: "string",
